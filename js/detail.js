define([
        ...
        var tmp = `
            ...
            <div class="detail_gallery l">
                <div class="detail_gallery_normal">
                    <img src="${data.photoNormal[0]}" alt="">
                    <span></span>
                </div>
                <div class="left_list">
                    <ul>
                        <li><a href="##"><img src="${data.photoNormal[0]}" alt=""></a></li>
                        <li><a href="##"><img src="${data.photoNormal[1]}" alt=""></a></li>
                        <li><a href="##"><img src="${data.photoNormal[2]}" alt=""></a></li>
                        <li><a href="##"><img src="${data.photoNormal[3]}" alt=""></a></li>
                        <li><a href="##"><img src="${data.photoNormal[4]}" alt=""></a></li>
                    </ul>
                </div>
                <div class="detail_gallery_large">
                    <img src="${data.photoLarge[0]}" alt="">
                </div>
            </div>
   ...
   // 选择图片
   function choosePhoto(data) {
        var list = document.querySelectorAll(".left_list li");
        var sImg = document.querySelector(".detail_gallery_normal img")
        var bImg = document.querySelector(".detail_gallery_large img");
        list[0].firstElementChild.style.border = "1px solid #ca141d";
        for(let i = 0;i < list.length; i++){
            list[i].onmouseover = function () {
                for (let j = 0;j < list.length; j++){
                    list[j].firstElementChild.style.border = 0;
                }
                sImg.src = data.photoNormal[i];
                bImg.src = data.photoLarge[i];
